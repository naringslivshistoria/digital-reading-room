...
const print = (logFn: Function, titleFn: Function, messageFn: Function, title: string, message: string, data?: object | string) => {
  if (data) {
    logFn(
      titleFn(title),
      messageFn(message),
...
export default {
  debug: (message: string, data?: object) => {
    ...
    print(console.debug, chalk.whiteBright.bold, chalk.gray, 'DEBUG', message, data)
  },
  ...
  info: (message: string, data?: object | string) => {
    ...
    print (console.log, chalk.whiteBright.bold, chalk.white, 'INFO ', message, data)
  },
